...
# Copy libs (tensorrt, opencv and missing libnvrtc)
COPY docker/open_cv /pdk_files
COPY docker/jetpack_files /pdk_files
COPY docker/jetpack_files/libnvrtc.so.10.2 /usr/local/cuda-10.2/targets/aarch64-linux/lib/
...
RUN apt-get update
RUN apt-get install -y cuda-cross-aarch64
...
# install opencv
RUN dpkg -x /pdk_files/OpenCV-4.4.0-aarch64-dev.deb /pdk_files/open_cv
RUN dpkg -x /pdk_files/OpenCV-4.4.0-aarch64-libs.deb /pdk_files/open_cv
RUN dpkg -x /pdk_files/OpenCV-4.4.0-aarch64-main.deb /pdk_files/open_cv
RUN dpkg -x /pdk_files/OpenCV-4.4.0-aarch64-python.deb /pdk_files/open_cv
RUN dpkg -x /pdk_files/OpenCV-4.4.0-aarch64-scripts.deb /pdk_files/open_cv
RUN dpkg -x /pdk_files/OpenCV-4.4.0-aarch64-licenses.deb /pdk_files/open_cv
